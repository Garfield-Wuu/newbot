...
#注意事项：这里如果雷达顶部有两颗螺丝，则写入YDLIDAR；如果雷达顶部有三颗螺丝，则写入M1C1_MINI；如果雷达接到USB串口板，则写入M1C1_MINI_TTYUSB
#如果雷达顶部有小红点，则设置为LD14
...
#fi
#要么写入M1C1_MINI_TTYUSB
#if ! grep -q "export LIDAR_TYPE=M1C1_MINI_TTYUSB" ~/.bashrc; then
#	echo "export LIDAR_TYPE=M1C1_MINI_TTYUSB" >> ~/.bashrc
#fi
#要么写入M1C1_MINI
